...
const RightColComponent = ({title, imgSrc, space, altClass = '', _body}) => {

    let rightColImg = imgSrc ? <img src={ imgSrc }/> : ''
    let stylemod = { top: space }
    let rootClass = `right-column__module ${ altClass }`
    let header = ''
    ...
    return (
        <div className={ rootClass } style={ stylemod }>
            { header }
